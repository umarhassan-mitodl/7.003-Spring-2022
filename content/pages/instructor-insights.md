...
- [General Institute Requirement (GIR): Laboratory Requirement](https://catalog.mit.edu/mit/undergraduate-education/general-institute-requirements/#laboratoryrequirementtext)
...
- 7.003 is a required subject for the [Bachelor of Science in Biology](https://catalog.mit.edu/degree-charts/biology-course-7/) and for the [Bachelor of Science in Chemical-Biological Engineering](https://catalog.mit.edu/degree-charts/chemical-biological-engineering-course-10-b/).
- 7.003 can be applied toward the departmental laboratory requirement for the [Bachelor of Science in Chemistry and Biology](https://catalog.mit.edu/degree-charts/chemistry-biology-course-5-7/) or the [Bachelor of Science in Computer Science and Biology](https://catalog.mit.edu/degree-charts/computer-science-molecular-biology-course-6-7/), but is not required.
